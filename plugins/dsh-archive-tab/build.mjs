/**
 * dsh-archive-tab 构建脚本。
 *
 * 两个产物：
 *  - lib/index.js   — 宿主半（纯 ESM / Node；@deepseek-ai/* 保持 external，
 *                     加载时通过 profile 的模块链解析）。
 *  - lib/client.js  — 客户端半，浏览器工厂 bundle，经 /plugins/dsh-archive-tab/
...
const PACKAGE_ID = 'dsh-archive-tab'
...
console.log('dsh-archive-tab: build complete (lib/index.js, lib/client.js)')
