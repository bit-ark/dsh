...
> dsh-work 的任务看板功能移植自 [dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui) 的 `packages/dsh-task-board`（Apache-2.0），署名与修改清单见 `plugins/dsh-work/NOTICE`；该部分文件按 Apache-2.0 授权，其余为 MIT。
